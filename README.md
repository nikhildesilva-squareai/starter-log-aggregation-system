...
![Intermediate](https://img.shields.io/badge/difficulty-intermediate-F59E0B) ![DevOps Engineering](https://img.shields.io/badge/course-DevOps%20Engineering-0056CE) ![12 hours](https://img.shields.io/badge/estimated-12h-lightgrey)

> **Square 1 AI** starter template — DevOps Engineering

## Overview

In this intermediate-level project, you'll build a **Log Aggregation System** using ELK Stack, Docker, Filebeat. Centralise logs from multiple services with search and visualisation. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-log-aggregation-system.git
cd starter-log-aggregation-system
